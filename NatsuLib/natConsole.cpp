...
natConsole::natConsole()
	: m_StdIn{ natStdStream::StdIn }, m_StdOut{ natStdStream::StdOut }, m_StdErr{ natStdStream::StdErr }, m_StdInReader{ m_StdIn.ForkRef()
#ifndef _WIN32
		, 1
#endif
	}, m_StdOutWriter{ m_StdOut.ForkRef() }, m_StdErrWriter{ m_StdErr.ForkRef() }
{
}
